...
@section('content')
    ...
    <main class="container mb-5" style="padding:16px 15px; border-radius:7px">
        <div class="row">
            <div class="col-md-9"
            ...
            <div class="col-md-3">
                <div class="text-jp" style="text-decoration: none">Bukti Jackpot Lainnya</div>
                <div class="row">
                                            ...
                                            <div class="d-grid gap-2 mt-3">
                                                <button style="font-weight:bold; font-size:13px;border:none;color:white"
                                                    type="button" class="btn button-jp btn-sm btn-sm show-button"><span
                                                        style="margin-right:15px">Read more</span><i
